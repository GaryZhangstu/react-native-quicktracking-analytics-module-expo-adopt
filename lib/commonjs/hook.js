...
const RNClickTouchableFilePath = dir + '/react-native/Libraries/Components/Touchable/Touchable.js'; //原RNClickFilePath
const RNClickPressabilityFilePath = dir + '/react-native/Libraries/Pressability/Pressability.js';
const RNClickableFiles = [dir + '/react-native/Libraries/Renderer/src/renderers/native/ReactNativeFiber.js', dir + '/react-native/Libraries/Renderer/src/renderers/native/ReactNativeFiber-dev.js', dir + '/react-native/Libraries/Renderer/src/renderers/native/ReactNativeFiber-prod.js', dir + '/react-native/Libraries/Renderer/src/renderers/native/ReactNativeFiber-profiling.js', dir + '/react-native/Libraries/Renderer/ReactNativeFiber-dev.js', dir + '/react-native/Libraries/Renderer/ReactNativeFiber-prod.js', dir + '/react-native/Libraries/Renderer/oss/ReactNativeRenderer-dev.js', dir + '/react-native/Libraries/Renderer/oss/ReactNativeRenderer-prod.js', dir + '/react-native/Libraries/Renderer/ReactNativeStack-dev.js', dir + '/react-native/Libraries/Renderer/ReactNativeStack-prod.js', dir + '/react-native/Libraries/Renderer/oss/ReactNativeRenderer-profiling.js', dir + '/react-native/Libraries/Renderer/ReactNativeRenderer-dev.js', dir + '/react-native/Libraries/Renderer/ReactNativeRenderer-prod.js', dir + '/react-native/Libraries/Renderer/implementations/ReactNativeRenderer-profiling.js', dir + '/react-native/Libraries/Renderer/implementations/ReactNativeRenderer-dev.js', dir + '/react-native/Libraries/Renderer/implementations/ReactNativeRenderer-prod.js'];

// react native slider files path
const RNSliderFiles = [dir + '/react-native/Libraries/Components/Slider/Slider.js', dir + '/react-native/Libraries/Components/Slider/Slider.js', dir + '/@react-native-community/slider/js/Slider.js', dir + '/@react-native-community/slider/dist/Slider.js', dir + '/@react-native-community/js/Slider.js', dir + '/@react-native-community/src/js/Slider.js'];
...
const RNSegmentedControlFilePath = [dir + '/react-native/Libraries/Components/SegmentedControlIOS/SegmentedControlIOS.ios.js', dir + '/@react-native-community/segmented-control/js/SegmentedControl.ios.js'];

// react native gestureButtons files path
const RNGestureButtonsFilePaths = [dir + '/react-native-gesture-handler/GestureButtons.js', dir + '/react-native-gesture-handler/src/components/GestureButtons.tsx'];
...
// iOS 全埋点已覆盖
const QTSliderHookCode = '(function(thatThis){\n' + '  try {\n' + "    const ReactNative = require('react-native');\n" + '    const qtModule = ReactNative.NativeModules.QuicktrackingAnalyticsModule;\n' + '    qtModule && qtModule?.onEventAutoCLK(event.nativeEvent.target);\n' + '  } catch (error) { \n' + "      throw new Error('QUICKTRACKING RN Hook Code 调用异常: ' + error);\n" + '  }\n' + '})(this); /* QUICKTRACKING HOOK */';
// iOS 全埋点覆盖
const QTSegmentedControlHookCode = 'if(this.props.onChange != null || this.props.onValueChange != null){\n' + '(function(thatThis){\n' + '  try {\n' + "    const ReactNative = require('react-native');\n" + '    const qtModule = ReactNative.NativeModules.QuicktrackingAnalyticsModule;\n' + '    qtModule && qtModule?.onEventAutoCLK(event.nativeEvent.target);\n' + '  } catch (error) { \n' + "      throw new Error('QUICKTRACKING RN Hook Code 调用异常: ' + error);}\n" + '})(this); /* QUICKTRACKING HOOK */}';
// iOS 全埋点已覆盖
...
function QTTouchableHookRN() {
  if (fs.existsSync(RNClickTouchableFilePath)) {
    ...
    const injectedContent = `${fileContent.substring(0, hookIndex)}\n${QTClickTouchableHookCode}\n${fileContent.substring(hookIndex)}`;

    // backup original Touchable.js file
    fs.renameSync(RNClickTouchableFilePath, `${RNClickTouchableFilePath}${QTBackUpSuffix}`);
...
function QTPressableHookRN() {
  if (fs.existsSync(RNClickPressabilityFilePath)) {
    ...
    fs.renameSync(RNClickPressabilityFilePath, `${RNClickPressabilityFilePath}${QTBackUpSuffix}`);
  ...
  RNSliderFiles.forEach(function (onefile) {
    if (fs.existsSync(onefile)) {
      ...
      if (reset) {
        ...
        // 插入 hook 代码
        const hookedContent = `${fileContent.substring(0, hookIndex + scriptStr.length)}\n${QTSliderHookCode}\n${fileContent.substring(hookIndex + scriptStr.length)}`;
        // 备份源文件
  ...
  RNClickableFiles.forEach(function (onefile) {
    if (fs.existsSync(onefile)) {
      if (reset) {
        ...
        const hookedContent = `${content.substring(0, splitIndex)}\n${call}\n${content.substring(splitIndex)}`;
